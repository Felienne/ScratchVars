...
While the original study has conducted a survey 
...
The original study of Beniamini et al. has concluded that the single-letter variable names ``are approximately as common as other short lengths except in PHP'' and that  ``in C, Java, and Perl they make up 9–20\% of the names.'' 

...
df = pd.read_csv(dir_path+'/input/code.csv', names = list(range(0,23)))#, nrows = 10000)
...
t['number_of_QuestionMarks'] = t.apply(numQuestionMark, axis=1)
t['firstCharisLetter'] = t.apply(firstCharisLetter, axis=1)



u = t.loc[:,['varname', 'number_of_spaces', 'number_of_QuestionMarks', 'firstCharisLetter', 'argument', 'varlength', 'datatype', 'vartype', 'projectid']]

u = u[(u['number_of_QuestionMarks'] > 0 )] 

u.to_csv(dir_path+'/output/all_question_mark_variables_with_arguments.csv')
